      ...
      <div class="modal fade" id="modal-edit<?php echo $row['id'] ?>">
        <div class="modal-dialog">
          <div class="modal-content">
              ...
              <form action="../conf/editproduk.php" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="is_active" placeholder="Enter angka aktif">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal edit</label>
                    <input type="datetime-local" class="form-control" name="updated_at" placeholder="Tanggal">
                  </div>
                  <div class="form-group">
            ...
            <!-- ADUADUSUDGDGIGDIDGIDGIDIDIDIDGIGDB -->
